...
if training:
    ...
    disc_hidden_sizes = range(1500, 1101, -50)
    gen_hidden_sizes = range(1500, 1101, -50)
    repetitions = 10

    global_min_kl_divergence = 100000000000000000
    best_gen_path = os.path.join(cwd, "saved_models", "best_cGAN_hybrid_extrapolation_model.h5")
...
path = os.path.join(cwd, "saved_models", "best_cGAN_hybrid_extrapolation_model.h5")
